...
def load_embeddings(male_pkl='data/male_embeddings.pkl', female_pkl='data/female_embeddings.pkl'):
    """
...
if __name__ == "__main__":
    ...
    # Load data
    df = load_embeddings('data/male_embeddings.pkl', 'data/female_embeddings.pkl')
